...
class Cell:
    ...
    def __sub__(self, other):
        diff = self.cell_count - other.cell_count
        if diff > 0:
            return Cell(self.cell_count - other.cell_count)
    ...
    def make_order(self, num_of_cells_in_a_row):
        res = ""
        i = 0
        while i < self.cell_count:
            char_count = self.cell_count - i if num_of_cells_in_a_row + i > self.cell_count else num_of_cells_in_a_row
            res = '\n'.join([res, "*" * char_count])
            i += num_of_cells_in_a_row
        return res
